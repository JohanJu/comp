...
/**
 * @ast node
 * @declaredat C:\\avx\\ws\\comp\\A3-CalcComp\\src\\jastadd\\calc.ast:6
...
public class Numeral extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat C:\\avx\\ws\\comp\\A3-CalcComp\\src\\jastadd\\PrettyPrint.jrag:27
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat C:\\avx\\ws\\comp\\A3-CalcComp\\src\\jastadd\\Visitor.jrag:38
   */
